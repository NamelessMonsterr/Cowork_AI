...
class UIAStrategy(Strategy):
    ...
    def can_handle(self, step: ActionStep) -> bool:
        ...
        has_uia_selector = step.selector is not None and step.selector.strategy == "uia"
    ...
    def execute(self, step: ActionStep) -> StrategyResult:
        ...
        if not HAS_PYWINAUTO:
            return StrategyResult(success=False, error="pywinauto not installed")
        ...
        try:
            ...
            if element is None:
                return StrategyResult(success=False, error="Element not found")
