    ...
    def update_app_stats(self, app_name: str, strategy: str, success: bool, duration_ms: float):
        ...
        if not profile:
            ...
            profile = {
                ...
                "uia_success_rate": 0.0, "vision_success_rate": 0.0, "coords_success_rate": 0.0,
                "sample_count": 0
            }
        ...
        if strategy == "UIA": rates["UIA"] = new_rate
        elif strategy == "Vision": rates["Vision"] = new_rate
        ...
        if c.fetchone():
            c.execute(f'''UPDATE app_profiles SET 
                          {col_name} = ?, 
                          preferred_strategy = ?, 
             ...
             c.execute(f'''INSERT INTO app_profiles 
