...
from assistant.ui_contracts.schemas import ActionStep, UISelector, VerifySpec, VerifyType
...
class SmartConverter:
    ...
    def _event_to_step(self, event: InputEvent, anchor: Optional[ContextAnchor], step_id: str) -> Optional[ActionStep]:
