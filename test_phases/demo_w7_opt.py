...
def main():
    ...
    # Setup step
    step_open = ActionStep(id="init", tool="open_app", args={"app_name": "notepad.exe"}, description="ensure notepad")
    ...
    # Using 'click' on 'File'
    step_click = ActionStep(id="click_file", tool="click", args={"name": "File", "control_type": "MenuItem"}, description="Click File")
    ...
    step_click_2 = ActionStep(id="click_file_2", tool="click", args={"name": "File", "control_type": "MenuItem"})
