...
from assistant.utils import (
    PrivacySanitizer, CoworkLogger, LogConfig, Timer,
    ScreenCapture, CaptureConfig, HAS_DXCAM, HAS_MSS,
    Permission, PluginManifest, PermissionManager,
)
...
def test_logger():
    ...
    print(f"   ✅ Sanitized logging works")
